...
import io.mzlnk.javalin.xt.internal.di.processing.SingletonMethod.Parameter
...
class SingletonDefinitionProcessorTest {
    ...
    fun `should create definition provider service file`() {
        ...
        assertThat(serviceFile.name).isEqualTo("META-INF/services/io.mzlnk.javalin.xt.di.definition.SingletonDefinitionProvider")
