...
import io.mzlnk.javalin.xt.di.JavalinDIException
...
class SingletonDefinitionContextTest {
    ...
    fun `should throw exception if there are defined multiple explicit lists of singletons for given type`() {
        ...
        exception.hasMessage("Multiple candidates found for java.util.List<? extends io.mzlnk.javalin.xt.internal.di.context.ComponentA>")
    }
    ...
    fun `should throw exception if there are multiple candidates for given component dependency`() {
        ...
        // then:
        exception.isInstanceOf(JavalinDIException::class.java)
        exception.hasMessage("Multiple candidates found for io.mzlnk.javalin.xt.internal.di.context.ComponentA")
    }
    ...
    fun `should throw exception if there are no candidates for given component dependency`() {
        ...
        // then:
        exception.isInstanceOf(JavalinDIException::class.java)
        exception.hasMessage("No candidates found for io.mzlnk.javalin.xt.internal.di.context.ComponentA")
    }
    ...
    fun `should throw exception if there is a dependency cycle between components`() {
        ...
        exception.hasMessage(
            ...
            Cycle #1:
            ┌->io.mzlnk.javalin.xt.internal.di.context.ComponentA -> io.mzlnk.javalin.xt.internal.di.context.ComponentC -> io.mzlnk.javalin.xt.internal.di.context.ComponentB -┐
            └------------------------------------------------------------------------------------------------------------------------------------------------------------------┘
            """.trimIndent()
        )
    }
