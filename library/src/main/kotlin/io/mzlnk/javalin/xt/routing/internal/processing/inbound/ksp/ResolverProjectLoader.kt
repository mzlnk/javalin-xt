...
internal object ResolverProjectLoader {
    ...
    private val KSFunctionDeclaration.asHandler: Endpoint.Handler
        get() =
            Endpoint.Handler(
                ...
                path = this.annotations.first { it.isTypeOf(io.mzlnk.javalin.xt.routing.Path::class.java) }
    ...
    private val KSAnnotation.isEndpointHandlerMarker: Boolean get() =
