...
fun JsonNode.find(path: PathReference): JsonNode? = path.parts.fold<PathReference.Part, JsonNode?>(this) { node, part ->
    when (part) {
...
fun JsonNode.traverse(func: (path: PathReference, node: JsonNode) -> Unit) {
